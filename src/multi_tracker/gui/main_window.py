...
from PySide2.QtWidgets import (
    ...
    QFileDialog, QSpinBox, QDoubleSpinBox, QCheckBox, QMessageBox, 
    QGroupBox, QFormLayout, QLineEdit, QScrollArea, QProgressBar, QApplication
)
...
class MainWindow(QMainWindow):
    ...
    **Data Export:**
    ...
    def __init__(self):
        ...
        self.roi_fitted_circle = None # Current best-fit circle (center_x, center_y, radius)
        ...
        self.btn_file.setToolTip("Browse and select the input video file for tracking. Supports common video formats (mp4, avi, mov, etc.)")
        ...
        self.btn_csv.setToolTip("Specify output file path for tracking data in CSV format. Includes TrackID, TrajectoryID, position, orientation, and state.")
        ...
        self.btn_video_out.setToolTip("Optional: Specify output video file path to save tracking visualization. Video shows trajectories, labels, and tracking overlays.")
        ...
        self.spin_max_targets.setToolTip("Maximum number of animals to track simultaneously. Should match the actual number of animals in your video.")
        ...
        self.spin_threshold.setToolTip("Intensity threshold for foreground detection. Higher values = more selective detection. Adjust based on contrast between animals and background.")
        ...
        self.spin_max_dist.setToolTip("Maximum distance (pixels) between predicted and detected positions for track assignment. Lower values = stricter matching.")
        ...
        self.enable_postprocessing.setToolTip("Enable automatic trajectory cleaning and optimization")
        ...
        self.spin_min_trajectory_length.setToolTip("Remove trajectories shorter than this (likely noise)")
        ...
        self.spin_max_velocity_break.setToolTip("Break trajectories at points exceeding this velocity (identity switches)")
        ...
        self.spin_max_distance_break.setToolTip("Break trajectories at points exceeding this distance jump")
        ...
        self.enable_histograms.setToolTip("Show real-time parameter histograms for debugging and parameter tuning")
        ...
        self.spin_histogram_history.setToolTip("Number of recent frames to include in histogram displays")
        ...
        self.spin_continuity_thresh.setToolTip("Number of frames needed to consider a track 'established'. Established tracks get priority in assignment algorithms.")
        ...
        self.spin_morph_size.setToolTip("Size of morphological kernel for noise removal. Larger values remove more noise but may merge nearby objects.")
        ...
        self.spin_min_contour.setToolTip("Minimum contour area (pixels) to be considered a valid detection. Helps filter out noise and artifacts.")
        ...
        self.chk_size_filtering.setToolTip("Filter detections by size range to exclude objects that are too small or too large to be your target animals.")
        ...
        self.spin_min_object_size.setToolTip("Minimum object size (pixels) for size filtering. Objects smaller than this will be ignored.")
        ...
        self.spin_max_object_size.setToolTip("Maximum object size (pixels) for size filtering. Objects larger than this will be ignored.")
        ...
        self.spin_max_contour_multiplier.setToolTip("Skip frames with too many contours (more than this multiplier × max targets). Prevents processing of extremely noisy frames.")
        ...
        self.chk_conservative_split.setToolTip("Attempt to split merged objects using erosion. Useful when animals are close together or touching.")
        ...
        self.spin_conservative_kernel.setToolTip("Kernel size for conservative splitting operations. Smaller values = more gentle splitting.")
        ...
        self.spin_conservative_erode.setToolTip("Number of erosion iterations for conservative splitting. More iterations = stronger separation.")
        ...
        self.spin_merge_threshold.setToolTip("Area threshold (pixels) above which objects are considered potentially merged and splitting is attempted.")
        ...
        self.chk_additional_dilation.setToolTip("Apply extra dilation to connect separated parts of thin animals (e.g., legs, antennae). May merge nearby objects.")
        ...
        self.spin_dilation_iterations.setToolTip("Number of dilation iterations to apply. More iterations = stronger connection of separated parts.")
        ...
        self.spin_dilation_kernel_size.setToolTip("Size of dilation kernel. Larger kernels connect parts that are further apart.")
        ...
        self.spin_min_detect.setToolTip("Number of consecutive frames with good detections needed to initialize tracking.")
        ...
        self.spin_min_detections_to_start.setToolTip("Minimum number of detections required in a frame to begin tracking (1 = start immediately when any animal is detected).")
        stability_form.addRow("Min Detections to Start:", self.spin_min_detections_to_start)
        ...
        self.spin_min_track.setToolTip("Number of consecutive frames with good tracking performance needed to consider the system stabilized.")
        ...
        self.spin_traj_hist.setToolTip("Length of trajectory trails to display (in seconds of video). Longer trails use more memory.")
        ...
        self.spin_bg_prime.setToolTip("Number of random frames to sample for building the initial background model. More frames = better background model.")
        ...
        self.chk_adaptive_bg.setToolTip("Continuously update background model to adapt to lighting changes. Disable for static lighting conditions.")
        ...
        self.spin_bg_learning.setToolTip("Learning rate for adaptive background updates. Higher values adapt faster to changes but are less stable.")
        ...
        self.chk_lighting_stab.setToolTip("Automatically compensate for gradual lighting changes throughout the video. Improves detection consistency.")
        ...
        self.spin_lighting_smooth.setToolTip("Smoothing factor for lighting stabilization. Higher values = slower adaptation to lighting changes.")
        ...
        self.spin_lighting_median.setToolTip("Window size for median filtering in lighting stabilization. Larger windows remove more noise but respond slower.")
        ...
        self.spin_kalman_noise.setToolTip("Process noise for Kalman filter. Higher values make predictions less confident, allowing for more erratic motion.")
        ...
        self.spin_kalman_meas.setToolTip("Measurement noise for Kalman filter. Higher values trust observations less, relying more on predictions.")
        ...
        self.spin_resize.setToolTip("Resize factor for video processing. Values < 1.0 improve performance but reduce accuracy. 0.5 = half resolution.")
        ...
        self.spin_brightness.setToolTip("Brightness adjustment for the video. Positive values brighten, negative values darken. Use to improve contrast.")
        ...
        self.spin_contrast.setToolTip("Contrast multiplier. Values > 1.0 increase contrast, < 1.0 decrease contrast. Use to enhance animal-background separation.")
        ...
        self.spin_gamma.setToolTip("Gamma correction factor. Values > 1.0 brighten mid-tones, < 1.0 darken mid-tones. Fine-tunes brightness curve.")
        ...
        self.chk_dark_on_light.setToolTip("Check if animals are darker than background (e.g., black flies on white paper). Uncheck for light animals on dark background.")
        ...
        self.spin_velocity.setToolTip("Velocity threshold (pixels/frame) for switching orientation tracking modes. Below this: smooth orientation changes. Above: align with motion direction.")
        ...
        self.chk_instant_flip.setToolTip("For fast-moving animals, instantly flip orientation to align with motion direction. Prevents 180° orientation errors.")
        ...
        self.spin_max_orient.setToolTip("Maximum orientation change per frame (degrees) for slow-moving animals. Prevents jittery orientation tracking.")
        ...
        self.spin_lost_thresh.setToolTip("Number of consecutive missed frames before declaring a track 'lost' and available for reassignment.")
        ...
        self.spin_min_respawn_distance.setToolTip("Minimum distance (pixels) between new detections and existing tracks for respawning. Prevents duplicate tracking.")
        ...
        self.spin_Wp.setToolTip("Weight for position cost in track assignment. Higher values prioritize position accuracy over other factors.")
        ...
        self.spin_Wo.setToolTip("Weight for orientation cost in track assignment. Higher values prioritize orientation consistency.")
        ...
        self.spin_Wa.setToolTip("Weight for area cost in track assignment. Higher values enforce size consistency between frames.")
        ...
        self.spin_Wasp.setToolTip("Weight for aspect ratio cost in track assignment. Higher values enforce shape consistency.")
        ...
        self.chk_use_mahal.setToolTip("Use Mahalanobis distance (considers prediction uncertainty) vs simple Euclidean distance for position cost calculation.")
        ...
        self.chk_show_fg.setToolTip("Display the foreground mask showing detected animal pixels after background subtraction and morphological processing.")
        ...
        self.chk_show_bg.setToolTip("Display the learned background model used for foreground detection. Helps verify background quality and detect lighting changes.")
        ...
        self.chk_show_circles.setToolTip("Draw colored circle markers at each animal's current position. Each trajectory has a unique color for easy identification.")
        ...
        self.chk_show_orientation.setToolTip("Draw lines indicating animal orientation/heading direction. Useful for analyzing movement patterns and directional behavior.")
        ...
        self.chk_show_trajectories.setToolTip("Draw colored trail lines showing recent path history for each animal. Trail length determined by trajectory history buffer.")
        ...
        self.chk_show_labels.setToolTip("Show persistent trajectory ID (T#) that maintains identity across track losses and tracking continuity count (C:#)")
        ...
        self.chk_show_state.setToolTip("Display tracking state information (Active/Lost/Predicted) for debugging track lifecycle and loss detection.")
        ...
        self.chk_enable_backward.setToolTip("Automatically run backward tracking after forward tracking completes (requires FFmpeg)")
        ...
        self.btn_start_roi.setToolTip("Begin interactive circular ROI selection. Click and drag on the video display to define tracking region.")
        ...
        self.btn_finish_roi.setToolTip("Complete ROI selection and apply the defined circular region for tracking analysis.")
        self.btn_clear_roi = QPushButton("Clear ROI")
        self.btn_clear_roi.clicked.connect(self.clear_roi)
        self.btn_clear_roi.setToolTip("Remove current ROI selection and revert to full-frame tracking.")
        ...
        self.roi_status_label.setStyleSheet("font-weight: bold; color: #666; padding: 5px; border: 1px solid #ccc; background: #f9f9f9;")
        roi_layout.addWidget(self.roi_status_label)
        
        # ROI instructions
        self.roi_instructions = QLabel("Click 'Start ROI Selection', then click points on the circle boundary in the video. A preview circle will appear after 3+ points.")
        ...
        self.btn_preview.setToolTip("Toggle real-time preview mode for parameter tuning. Shows tracking without saving data to CSV.")
        ...
        self.btn_start.setToolTip("Start complete tracking analysis with CSV data export. Processes entire video and saves trajectory data.")
        
        # Emergency stop button
        self.btn_stop = QPushButton("Stop")
        self.btn_stop.clicked.connect(self.stop_tracking)
        self.btn_stop.setToolTip("Stop current tracking operation immediately. Use this to abort processing if needed.")
    ...
    def select_file(self):
        ...
        self.video_label.setText("Video loaded. Click 'Start ROI Selection' to define tracking area.")
    ...
    def update_roi_preview(self):
        ...
        if len(self.roi_points) >= 3:
            ...
            if circle_fit:
                ...
                # Update status
                self.roi_status_label.setText(f"Preview: {len(self.roi_points)} points, radius {radius:.1f}px")
                self.btn_finish_roi.setEnabled(True)
            else:
                self.roi_status_label.setText(f"Invalid fit with {len(self.roi_points)} points")
                self.btn_finish_roi.setEnabled(False)
        else:
            # Not enough points yet
            self.roi_status_label.setText(f"Need {3 - len(self.roi_points)} more points (minimum 3)")
            self.btn_finish_roi.setEnabled(False)
    ...
    def start_roi_selection(self):
        ...
        self.roi_instructions.setText("Click points around the circular boundary. Preview circle appears after 3 points. Press Escape to cancel, or click 'Finish ROI' when satisfied.")
    ...
    def finish_roi_selection(self):
        ...
        if self.roi_base_frame:
            ...
            self.btn_finish_roi.setEnabled(False)
            self.roi_status_label.setText(f"ROI set: center ({cx:.1f}, {cy:.1f}), radius {radius:.1f}px")
            self.roi_instructions.setText("ROI successfully defined. You can now start tracking.")
            
            # Clear video display
            self.video_label.clear()
            self.video_label.setText("ROI defined. Ready for tracking.")
            
            logger.info(f"ROI defined: center=({cx:.1f}, {cy:.1f}), radius={radius:.1f}")
    ...
    def clear_roi(self):
        ...
        self.roi_instructions.setText("Click 'Start ROI Selection', then click points on the circle boundary in the video. A preview circle will appear after 3+ points.")
    ...
    def toggle_histogram_window(self):
        ...
        if self.histogram_window is None:
            ...
            if self.histogram_panel is None:
                self.histogram_panel = HistogramPanel(history_frames=self.spin_histogram_history.value())
            ...
            self.histogram_window.closeEvent = lambda event: (on_close(), event.accept())
    ...
    def load_config(self):
        ...
        try:
            ...
            # Restore core tracking parameters
            ...
            self.spin_max_contour_multiplier.setValue(cfg.get("max_contour_multiplier", 20))
            
            self.spin_max_dist.setValue(cfg.get("max_dist_thresh", 25))
            self.enable_postprocessing.setChecked(cfg.get("enable_postprocessing", True))
            self.spin_min_trajectory_length.setValue(cfg.get("min_trajectory_length", 10))
            ...
            self.spin_min_detections_to_start.setValue(cfg.get("min_detections_to_start", 1))
            ...
            self.chk_conservative_split.setChecked(cfg.get("enable_conservative_split", True))
            self.spin_merge_threshold.setValue(cfg.get("merge_area_threshold", 1000))
            self.spin_conservative_kernel.setValue(cfg.get("conservative_kernel_size", 3))
            ...
            self.spin_histogram_history.setValue(cfg.get("histogram_history_frames", 300))
            
            # Restore additional dilation parameters for thin animals
            self.chk_additional_dilation.setChecked(cfg.get("enable_additional_dilation", False))
            ...
            self.chk_enable_backward.setChecked(cfg.get("enable_backward_tracking", True))
    ...
    def on_histogram_data(self, histogram_data):
        ...
        if (self.enable_histograms.isChecked() and 
            self.histogram_window is not None and 
            self.histogram_window.isVisible()):
            ...
            if 'orientations' in histogram_data and histogram_data['orientations']:
                self.histogram_panel.update_orientation_data(histogram_data['orientations'])
                
            if 'assignment_costs' in histogram_data and histogram_data['assignment_costs']:
                self.histogram_panel.update_assignment_cost_data(histogram_data['assignment_costs'])
    ...
    def start_backward_tracking(self):
        ...
        video_fp = self.file_line.text()
        if not video_fp:
            QMessageBox.warning(self, "No video", "No video file available for backward tracking.")
            return
    ...
    def start_tracking_on_video(self, video_path, backward_mode=False):
        ...
        if self.csv_line.text():
            hdr = ["TrackID", "TrajectoryID", "Index", "X", "Y", "Theta", "FrameID", "State"]
